...
configuration_dir=configs/stat
pwd_dir=$(pwd)
...
configuration_dir=configs/sys/1
pwd_dir=$(pwd)
mkdir -p $configuration_dir
sed -e 's/@identifier/DATA/' \
    -e 's/@massMin/"70"/' \
...
configuration_dir=configs/sys/2
pwd_dir=$(pwd)
mkdir -p $configuration_dir
sed -e 's/@identifier/DATA/' \
    -e 's/@massMin/"70"/' \
...
configuration_dir=configs/sys/3
pwd_dir=$(pwd)
mkdir -p $configuration_dir
sed -e 's/@identifier/DATA/' \
    -e 's/@massMin/"60"/' \
...
configuration_dir=configs/sys/4
pwd_dir=$(pwd)
mkdir -p $configuration_dir
sed -e 's/@identifier/DATA/' \
    -e 's/@massMin/"50"/' \
