...
InputFileNames = cms.vstring("file://../data/TnPTree_80X_DYLL_M50_MadGraphMLM_part1.root")
InputDirectoryName = cms.string("tpTree")
InputTreeName = cms.string("fitter_tree")
OutputFileName = cms.string("data/MuonTagAndProbe_MC.root")
...
Efficiencies = cms.PSet(
    MuonEfficiency = cms.PSet(
        ...
        BinnedVariables = cms.PSet(
            ...
            pt = cms.vdouble(np.linspace(30, 100, 40)),
