...
Expressions = cms.PSet(
    Exp_IsoMu20 = cms.vstring("Exp_IsoMu20", "IsoMu20==1", "IsoMu20"),
)

# Define cuts on variables
# Leave it empty if you don't need this feature.
Cuts = cms.PSet(
    Cut_IsoMu20 = cms.vstring("Cut_IsoMu20", "Exp_IsoMu20", "0.5"),
)
...
Efficiencies = cms.PSet(
    MuonEfficiency = cms.PSet(
        ...
        EfficiencyCategoryAndState = cms.vstring("Cut_IsoMu20", "above"),
