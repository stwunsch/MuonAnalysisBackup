...
OutputFileName = cms.string("MuonTagAndProbe_DATA_delEta0p025.root")
...
Expressions = cms.PSet(
    Exp_IsoTkMu22 = cms.vstring("Exp_IsoTkMu22", "IsoTkMu22==1", "IsoTkMu22"),
)

# Define cuts on variables
# Leave it empty if you don't need this feature.
Cuts = cms.PSet(
    Cut_IsoTkMu22 = cms.vstring("Cut_IsoTkMu22", "Exp_IsoTkMu22", "0.5"),
)
...
Efficiencies = cms.PSet(
    MuonEfficiency = cms.PSet(
        ...
        EfficiencyCategoryAndState = cms.vstring("Cut_IsoTkMu22", "above"),
